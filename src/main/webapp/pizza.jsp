...
<form action="hello-servlet" method="post">
    ...
    <select name="pizza">
        ...
        <option value="Чотири сира">Чотири сира</option>
        <option value="Капрічоза">Капрічоза</option>
        <option value="Гавайська">Гавайська</option>
    </select><br>
    ...
    <label for="address">New Pizza</label>
    <a href="NewPizza/newpizza.jsp">newpizza</a><br>
